...
#include "PDAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FPDAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UPDAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FPDAbilityTagRelationship> AbilityTagRelationships;
