...
#include "PDAbilityCost.generated.h"
 ...
 * UPDAbilityCost
 *
 * Base class for costs that a PDGameplayAbility has (e.g., ammo or charges)
 */
UCLASS(DefaultToInstanced, EditInlineNew, Abstract)
class PROJECTD_API UPDAbilityCost : public UObject
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	virtual bool CheckCost(const UPDGameplayAbility* Ability, const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, FGameplayTagContainer* OptionalRelevantTags) const
	{
		return true;
	}
	 ...
	 */
	virtual void ApplyCost(const UPDGameplayAbility* Ability, const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo)
	{
	}
