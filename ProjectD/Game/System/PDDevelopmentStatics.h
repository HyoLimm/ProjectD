...
#include "PDDevelopmentStatics.generated.h"
...
UCLASS()
class UPDDevelopmentStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()

public:
	// Should game logic skip directly to gameplay (skipping any match warmup / waiting for players / etc... aspects)
	// Will always return false except when playing in the editor and bTestFullGameFlowInPIE (in PD Developer Settings) is false
	...
	// Will always return true except when playing in the editor and bSkipLoadingCosmeticBackgroundsInPIE (in PD Developer Settings) is true
	UFUNCTION(BlueprintCallable, Category = "PD", meta=(ExpandBoolAsExecs="ReturnValue"))
