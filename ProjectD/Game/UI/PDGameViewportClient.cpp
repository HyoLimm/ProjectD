...
#include "Game/UI/PDGameViewportClient.h"

#include "CommonUISettings.h"
#include "ICommonUIModule.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(PDGameViewportClient)
...
UPDGameViewportClient::UPDGameViewportClient()
	: Super(FObjectInitializer::Get())
{

}

void UPDGameViewportClient::Init(struct FWorldContext& WorldContext, UGameInstance* OwningGameInstance, bool bCreateNewAudioDevice /*= true*/)
{
