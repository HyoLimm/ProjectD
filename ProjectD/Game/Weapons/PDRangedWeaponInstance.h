...
#include "PDRangedWeaponInstance.generated.h"

class UPhysicalMaterial;

/**
 * UPDRangedWeaponInstance
 *
 * A piece of equipment representing a ranged weapon spawned and applied to a pawn
 */
UCLASS()
class UPDRangedWeaponInstance : public UPDWeaponInstance, public IPDAbilitySourceInterface
{
	GENERATED_BODY()

public:
	UPDRangedWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
public:
	...
	//~UPDEquipmentInstance interface
	virtual void OnEquipped();
	virtual void OnUnequipped();
	//~End of UPDEquipmentInstance interface

	void AddSpread();

	//~IPDAbilitySourceInterface interface
	...
	//~End of IPDAbilitySourceInterface interface
