...
#include "PDWeaponInstance.generated.h"
 ...
 */
UCLASS()
class UPDWeaponInstance : public UPDEquipmentInstance
{
	GENERATED_BODY()

public:
	UPDWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	FPDAnimLayerSelectionSet EquippedAnimSet;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=Animation)
	FPDAnimLayerSelectionSet UneuippedAnimSet;
