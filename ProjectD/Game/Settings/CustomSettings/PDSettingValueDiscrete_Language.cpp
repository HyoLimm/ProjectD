...
#include "PDSettingValueDiscrete_Language.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(PDSettingValueDiscrete_Language)

#define LOCTEXT_NAMESPACE "PD"

static const int32 SettingSystemDefaultLanguageIndex = 0;

UPDSettingValueDiscrete_Language::UPDSettingValueDiscrete_Language()
{
}

void UPDSettingValueDiscrete_Language::OnInitialized()
{
	Super::OnInitialized();
...
void UPDSettingValueDiscrete_Language::StoreInitial()
{
	// ?
}

void UPDSettingValueDiscrete_Language::OnApply()
{
...
void UPDSettingValueDiscrete_Language::ResetToDefault()
{
	SetDiscreteOptionByIndex(SettingSystemDefaultLanguageIndex);
}

void UPDSettingValueDiscrete_Language::RestoreToInitial()
{
	if (UPDSettingsShared* Settings = CastChecked<UPDLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
void UPDSettingValueDiscrete_Language::SetDiscreteOptionByIndex(int32 Index)
{
	if (UPDSettingsShared* Settings = CastChecked<UPDLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
int32 UPDSettingValueDiscrete_Language::GetDiscreteOptionIndex() const
{
	if (const UPDSettingsShared* Settings = CastChecked<UPDLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
TArray<FText> UPDSettingValueDiscrete_Language::GetDiscreteOptions() const
{
