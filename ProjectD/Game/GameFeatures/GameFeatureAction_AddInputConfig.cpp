...
//#include "Character/PDHeroComponent.h"	// for NAME_BindInputsNow
...
#include "Game/Input/PDMappableConfigPair.h"
...
void UGameFeatureAction_AddInputConfig::HandlePawnExtension(AActor* Actor, FName EventName, FGameFeatureStateChangeContext ChangeContext)
{
	...
	if (EventName == UGameFrameworkComponentManager::NAME_ExtensionAdded || EventName == UPDHeroComponent::NAME_BindInputsNow)
	{
