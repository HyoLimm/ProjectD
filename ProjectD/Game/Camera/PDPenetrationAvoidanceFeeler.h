...
#include "PDPenetrationAvoidanceFeeler.generated.h"

/**
 * Struct defining a feeler ray used for camera penetration avoidance.
 */
USTRUCT()
struct FPDPenetrationAvoidanceFeeler
{
	GENERATED_BODY()
	...
	FPDPenetrationAvoidanceFeeler(const FRotator& InAdjustmentRot,
